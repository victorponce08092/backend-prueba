  ...
  fetch(`${BASE_URL}/api/designs/${wid}`).then(r=>r.json()).then(d=>{
    ...
    doc.open();doc.write(`
      ...
      *{margin:0;padding:0;box-sizing:border-box}
      ...
      <body>
        <div class="header"><div class="header-left"><div class="green-dot"></div><span class="header-title">Asistente</span></div><button id="closeBtn" class="close-btn">${SVGS.X}</button></div>
        <div class="messages" id="messages"><div class="bot-row"><div class="bot-icon">${SVGS.Bot}</div><div class="bot-bubble">¡Hola! 👋 ¿En qué puedo ayudarte?</div></div></div>
